...
import { SiLinkedin, SiBehance, SiGithub, SiInstagram } from "react-icons/si";
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          >
            <Card>
              ...
              <div className="mt-6 space-y-3">
                <InfoRow icon={Mail} label="Email" value="yasiruln215@gmail.com" href="mailto:yasiruln215@gmail.com" />
            ...
            <Card className="mt-6 p-0 flex-1 flex flex-col">
              <div className="relative flex-1 overflow-hidden rounded-2xl min-h-[250px]">
                <iframe
          ...
          >
            <Card className="p-6 sm:p-8 flex-1 flex flex-col justify-between">
              ...
              <form onSubmit={onSubmit} noValidate className="mt-6 flex-1 flex flex-col justify-between gap-4">
                {/* honeypot */}
                <input
                  type="text"
                  name="company"
                ...
                <div className="space-y-1.5">
                  <label className="text-sm font-medium text-slate-200">
                    Project Brief / Overview (Optional)
                  </label>
                  <label
                    htmlFor="file-upload"
                    className="flex cursor-pointer flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-white/20 bg-white/5 px-4 py-6 transition hover:bg-white/10 hover:border-purple-400/50"
                  >
                    <div className="flex flex-col items-center gap-2 text-center text-sm text-slate-400 group">
                      <svg className="h-6 w-6 text-slate-400 group-hover:text-purple-400 transition" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function InfoRow({ icon: Icon, label, value, href }) {
  ...
  return (
    <Cmp
      href={href}
      className={`group flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 p-3 ${href ? "hover:bg-white/10" : ""
        }`}
